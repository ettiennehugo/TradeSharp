...
namespace TradeSharp.Data.Testing
{
  ...
  public class DataFeed
  {
    ...
    public DataFeed()
    {
      ...
      m_exchange = new Exchange(Guid.NewGuid(), Exchange.DefaultAttributeSet, m_country.Id, "TestExchange", m_timeZone, Guid.Empty);
      m_instrumentInceptionDate = DateTime.Now.ToUniversalTime();
      m_instrument = new Instrument(Guid.NewGuid(), Instrument.DefaultAttributeSet, InstrumentType.Stock, "TEST", "TestInstrument", "TestInstrumentDescription", m_instrumentInceptionDate, Array.Empty<Guid>(), m_exchange.Id, Array.Empty<Guid>()); //database layer stores dates in UTC
