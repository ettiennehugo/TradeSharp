...
namespace TradeSharp.CoreUI.Repositories
{
  ...
  /// </summary>
  public interface IInstrumentBarDataRepository : IInstrumentDataRepository<IBarData>, IReadOnlyRepository<IBarData, DateTime>, IEditableRepository<IBarData, DateTime> { }
}
