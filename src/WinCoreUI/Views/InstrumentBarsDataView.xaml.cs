...
namespace TradeSharp.WinCoreUI.Views
{
  ...
  /// </summary>
  public sealed partial class InstrumentBarsDataView : Page
  {
    //constants
    ...
    private void m_dataProviders_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
      ...
      //TODO: Set the selection for all the ViewModels for the different resolutions displayed in the tab page.
    ...
    private void m_instruments_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
      ...
      //TODO: Set the selection for all the Viewmodels for the different resoluton displaed in the tab page.
