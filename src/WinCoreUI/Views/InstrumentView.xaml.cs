...
namespace TradeSharp.WinCoreUI.Views
{
  ...
  public sealed partial class InstrumentView : Page
  {
    ...
    public InstrumentView()
    {
      ...
      Instrument = new Instrument("", Instrument.DefaultAttributeSet, "", InstrumentType.Stock, Array.Empty<string>(), "", "", DateTime.Today, Instrument.DefaultPriceDecimals, Instrument.DefaultMinimumMovement, Instrument.DefaultBigPointValue, Exchange.InternationalId, Array.Empty<Guid>());
