...
namespace TradeSharp.WinCoreUI.Views
{
  ...
  public sealed partial class ExchangeView : Page
  {
    ...
    public ExchangeView()
    {
      loadCountries();
      loadTimeZones();
      Exchange = new Exchange(Guid.NewGuid(), Exchange.DefaultAttributeSet, "", Guid.Empty, "", TimeZoneInfo.Local, Instrument.DefaultPriceDecimals, Instrument.DefaultMinimumMovement, Instrument.DefaultBigPointValue, Guid.Empty);
